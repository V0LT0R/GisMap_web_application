...
const DEMAND_ZONES: DemandZone[] = [
  {
    id: "expo-turan",
    name: "EXPO / проспект Туран",
    type: "growth",
    lat: 51.0909,
    lon: 71.4182,
    demand: 9,
    radiusKm: 1.25,
    reason: "активная жилая застройка, деловая активность, поток к EXPO и аэропорту",
  },
  {
    id: "mangilik-kabanbay",
    name: "Мангилик Ел / Кабанбай батыра",
    type: "mixed",
    lat: 51.1088,
    lon: 71.4317,
    demand: 8,
    radiusKm: 1.15,
    reason: "плотные ЖК, университеты, офисы и высокий автомобильный поток",
  },
  {
    ...
    demand: 7,
    radiusKm: 1.05,
    reason: "административный центр, торговые объекты и регулярный дневной трафик",
  },
  {
    id: "uly-dala",
    name: "Улы Дала / новые ЖК",
    type: "residential",
    lat: 51.0872,
    lon: 71.4534,
    demand: 9,
    radiusKm: 1.35,
    reason: "новые жилые комплексы и растущая плотность населения",
  },
  {
    id: "sauran-syganak",
    name: "Сауран / Сыганак",
